...
def unet(IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS, kernel_size):
    ...
    #outputs = tf.keras.layers.Conv2DTranspose(1, kernel_size=kernel_size*4, strides=(8, 8), padding='same', activation='sigmoid')(c9)
